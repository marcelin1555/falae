...
SUITES = [
    ...
    ("teste_perfil.lua", "trocar nome, PIN e bloqueados no dedo"),
    ("teste_loja.lua", "o computador da loja"),
    ("teste_chave.lua", "a chave por disquete"),
    ("teste_denuncias.lua", "denuncias"),
    ("teste_orelhao.lua", "orelhao - ligacoes anonimas"),
    ("teste_orelhao_app.lua", "orelhao - o terminal, ponta a ponta"),
    ...
    ("teste_console_menu.lua", "o rodape do balcao, pelo dedo"),
    ("teste_modal.lua", "o dialogo modal"),
    ("teste_arranjo.lua", "a matematica do layout"),
